...
import { HotelFiltersPipe } from 'src/app/pipes/hotel-filters.pipe.pipe';
...
@Component({
  ...
  providers: [HotelFiltersPipe, OrderByPipe, StarRatingFilterPipe, PriceFilterPipe, BreakfastTypeFilterPipe,FacilityFilterPipe]
})
export class HotelsListingComponent implements OnInit {

  @ViewChild(HotelSearchFormComponent, {static: true}) child;
