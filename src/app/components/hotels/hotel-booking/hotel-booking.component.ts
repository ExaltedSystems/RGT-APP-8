...
export class HotelBookingComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.bookingInfoFrom = this.__fb.group({
      ...
      phone: ['', [Validators.required, Validators.minLength(10), Validators.maxLength(19), Validators.pattern(this._ms.phonePattern)]],
      email: ['', [Validators.required, Validators.email, Validators.pattern(this._ms.emailPattern)]],
    ...
    this.paymentInfoForm = this.__fb.group({
      ...
      cvn: ['', [Validators.required, Validators.minLength(3), Validators.maxLength(3)]],
