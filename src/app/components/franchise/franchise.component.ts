...
export class FranchiseComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.franchiseForm = this.__fb.group({
      ...
      mobile_no: ["", [Validators.required, Validators.minLength(10), Validators.maxLength(19), Validators.pattern(this.__ms.phonePattern)]],
      investment: ["", [Validators.required, Validators.minLength(5), Validators.maxLength(9), Validators.pattern('^(?=.*[0-9])[ +0-9]+$')]],
      tel_no: ["", [Validators.required, Validators.minLength(10), Validators.maxLength(19), Validators.pattern(this.__ms.phonePattern)]],
      city: [""],
      address: [""],
      education: [""],
